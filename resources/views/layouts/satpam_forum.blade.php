    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <div class="submenu submenu-open">
                ...
                <a href="{{ route('satpam') }}" class="active">SATPAM</a>
            </div>
        ...
        <form>
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="pertanyaan">
                            <span>Text for Row 1</span> <!-- Static text instead of input -->
                        </td>
                        <td class="centang">
            ...
            <a href="{{ route('satpam') }}" type="button" class="btn btn-danger btn-lg"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-backspace" viewBox="0 0 16 16">
