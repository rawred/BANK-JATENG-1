<!DOCTYPE html>
    ...
    <body>
        ...
        <form>
            ...
            <a href="{{ route('customer_service') }}" type="button" class="btn btn-danger btn-lg"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-backspace" viewBox="0 0 16 16">
